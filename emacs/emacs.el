...
(custom-set-variables
 ...
 '(package-selected-packages
   '(yaml-mode fzf jetbrains-darcula-theme material-theme nord-theme cider clojure-mode gruvbox-theme dracula-theme magit company go-mode php-mode lsp-mode paredit gruber-darker-theme smex)))
(custom-set-faces
